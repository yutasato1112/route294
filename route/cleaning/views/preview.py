    ...
    def post(self, request, *args, **kwargs):
        ...
        for i in range(pages):
            ...
            persons_cleaning_data = {
                ...
                'assigned_linen_closet':language('assigned_linen_closet',lang,None),
                'stock_check':language('stock_check',lang,None),
                'linen_closet_lock':language('linen_closet_lock',lang,None),
                'linen_closet_lock_2':language('linen_closet_lock_2',lang,None),
                'key_instructions':language('key_instructions',lang,None),
                'lang':lang,
