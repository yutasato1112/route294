...
SECRET_KEY = 'django-insecure-_ctinsj@pt5e-6x67emo8z$g3v1dw)4%_$5v#_&hnbwheu(0k='
...
if EMAIL_JSON_PATH.exists():
    ...
    if email_info.get('address') and email_info.get('password'):
